      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
            <h1 className="text-5xl lg:text-7xl font-extrabold mb-6 font-sans" data-testid="hero-name">
              <span className="text-foreground">Saif</span>
              <span className="text-primary"> Akhtar</span>
            </h1>

            <p className="text-2xl lg:text-3xl text-muted-foreground mb-8 font-light" data-testid="hero-tagline">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl" data-testid="hero-description">
              Full-stack developer specializing in modern web applications, turning innovative ideas into scalable digital solutions.
            </p>
